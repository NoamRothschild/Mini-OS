...
inline fn initTable() void {
    // Null Descriptor
    entries[offsets.nulld] = comptime makeState(.{
        .base = 0,
        .limit = 0,
        .access = .{},
        .flags = 0,
    ...
    entries[offsets.kernel_codeseg] = comptime makeState(.{
        .base = 0x00000000,
        .limit = 0xFFFFF,
    ...
    entries[offsets.kernel_dataseg] = comptime makeState(.{
        .base = 0x00000000,
        .limit = 0xFFFFF,
    ...
    tss_entry.ss0 = @truncate(comptime tableOffsetOf(offsets.kernel_dataseg));
